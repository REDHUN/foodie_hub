...
//                                     final location = locationProvider.getDisplayLocation();
//                                     return Text(
//                                       location.isEmpty ? 'Select your location' : location,
//                                       style: TextStyle(
...
//   Widget _buildOfferCard(String code, String title, String description, Color color) {
//     return Container(
...
//               Row(
//                 children: [
//                   Icon(Icons.help, color: AppColors.primaryColor),
//                   const SizedBox(width: 12),
//                   const Text(
//                     'Help & Support',
//                     style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
...
//                 subtitle: const Text('support@foodiehub.com'),
//                 onTap: () {},
//               ),
//             ],
//           ),
...
//               const SizedBox(height: 20),
//               const Text(
//                 'FoodieHub is your go-to food delivery app that connects you with the best restaurants in your area.',
